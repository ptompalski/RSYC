...
![Species-specific RSYC curves across Canada’s 150 km tile
grid.](reference/figures/RSYC_curves_species_gh.png)

Species-specific RSYC curves across Canada’s 150 km tile grid.
...
lists every match. Choose the intended area using the full sequence of
ecological areas shown by
...
![Black spruce volume curves and maps at four nested ecological
levels.](reference/figures/PICE_MAR_nested_ecosystem_maps_and_volume_curves.png)

Black spruce volume curves and maps at four nested ecological levels.
...
combinations.](reference/figures/README-curve-plot-1.png)

See [Prediction
examples](https://ptompalski.github.io/RSYC/vignettes/articles/Prediction-examples.Rmd)
...
- [`available_rsyc_models()`](https://ptompalski.github.io/RSYC/reference/available_rsyc_models.md)
  lists individual published curves that match a response, species, type
  of area, or area name. For example, list the volume curves for black
  spruce at the ecozone level:
...
- [`rsyc_species()`](https://ptompalski.github.io/RSYC/reference/rsyc_species.md)
  lists the species available for a selected response and area. It also
  gives each species’ common name and model group. For example, list the
  AGB species available in tile H14:
...
- [`rsyc_strata()`](https://ptompalski.github.io/RSYC/reference/rsyc_strata.md)
  lists the areas for which models are available for a selected response
  and species. It gives both the short area name and the full
  hierarchical area identifier, which can distinguish repeated area
  names. For example, list the ecozones with volume models for black
  spruce:
...
### Generate multiple yield curves for species and areas

[`rsyc_product()`](https://ptompalski.github.io/RSYC/reference/rsyc_product.md)
prepares yield estimates and the matching area boundaries. The
boundaries are stored separately so the same map shape is not repeated
for every species and stand age. By default, the function estimates ages
1 through 150:
